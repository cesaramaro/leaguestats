        ...
        <div className="flex rounded-lg ">
            ...
            <div className="flex flex-col rounded-bar-black p-12 w-300 h-500">
                <div name="icon-lvl" className="flex h-fill w-fill justify-center">
                    <div name="player-icon" className="relative rounded-full bg-purple-300 border-4 border-purple-400 flex items-center justify-center w-100">
                        <img className="object-cover rounded-full z-1" src={icon} alt=""></img>
                        <span name="player-level" className="absolute left-0 bottom-0 border-2 border-purple-400 rounded-full bg-purple-200 h-25 w-25">
